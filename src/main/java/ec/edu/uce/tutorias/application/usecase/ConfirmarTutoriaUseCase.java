...
@Service
public class ConfirmarTutoriaUseCase {

    private final TutoriaRepository tutoriaRepository;

    public ConfirmarTutoriaUseCase(TutoriaRepository tutoriaRepository) {
    ...
    public void ejecutar(String tutoriaId, String docenteId) {
        ...
        if (!tutoria.getDocenteId().equals(docenteId)) {
            throw new DomainException("Solo el docente asignado puede confirmar la tutoría");
        }
